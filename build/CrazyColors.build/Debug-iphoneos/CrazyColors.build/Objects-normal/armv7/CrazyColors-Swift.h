...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CrazyColors",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11CrazyColors11AppDelegate")
...
SWIFT_CLASS("_TtC11CrazyColors18GamePlaySceneClass")
@interface GamePlaySceneClass : SKScene <GADInterstitialDelegate, SKPhysicsContactDelegate>
...
SWIFT_CLASS("_TtC11CrazyColors18GameViewController")
@interface GameViewController : UIViewController <GADBannerViewDelegate, GADInterstitialDelegate>
@property (nonatomic, weak) IBOutlet GADBannerView * _Null_unspecified adBannerView;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC11CrazyColors19HowToPlaySceneClass")
@interface HowToPlaySceneClass : SKScene
- (void)touchesEnded:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (void)touchesBegan:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (void)didMoveToView:(SKView * _Nonnull)view;
- (nonnull instancetype)initWithSize:(CGSize)size OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC11CrazyColors13MainMenuScene")
@interface MainMenuScene : SKScene <GADBannerViewDelegate>
- (void)didMoveToView:(SKView * _Nonnull)view;
- (void)touchesEnded:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (void)touchesBegan:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
...
SWIFT_CLASS("_TtC11CrazyColors6Player")
