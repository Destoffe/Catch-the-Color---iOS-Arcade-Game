...
class ItemController {
    ...
    public func spawnItems() -> SKShapeNode{
        let item: SKShapeNode?;
         let color1 = hexStringToUIColor(hex: "#0392cf") // blue
         let color2 = hexStringToUIColor(hex: "#ee4035") // red
         let color3 = hexStringToUIColor(hex: "#7bc043") // green
         let color4 = hexStringToUIColor(hex: "#FDF146") // yellow
         let color5 = hexStringToUIColor(hex: "#f37736") // orange
         let color6 = hexStringToUIColor(hex: "#b967ff") // purple
         let color7 = hexStringToUIColor(hex: "#ffffff") // black
