...
class GamePlaySceneClass: SKScene, SKPhysicsContactDelegate,GADInterstitialDelegate{
    ...
    override func touchesEnded(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        restartButton?.texture = SKTexture(imageNamed:"red_button01.png")
        rateButton?.texture = SKTexture(imageNamed:"blue_button01.png")
        shareButton?.texture = SKTexture(imageNamed:"green_button04.png")
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        for touch in touches{
            ...
            if atPoint(location).name == "Blue" {
                ...
                restartButton?.texture = SKTexture(imageNamed:"red_button02.png")
            }else if atPoint(location).name == "Rate" {
                ...
                shareButton?.texture = SKTexture(imageNamed:"green_button05.png")
                let controller = self.view?.window?.rootViewController as! GameViewController
